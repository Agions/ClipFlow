...
fn build_storyline_json(
    metadata: &crate::types::VideoMetadataResult,
...
/// 计算 artifacts 目录：`appData/StoryFab/productions/{id}/artifacts`
...
pub async fn analyze_production(
    ...
    let metadata = crate::commands::ffprobe::analyze_video(video_path.clone()).await?;
